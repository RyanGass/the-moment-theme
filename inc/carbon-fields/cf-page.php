        ...
        ->add_fields( array(
            Field::make( 'complex', 'crb_sections', 'Sections' )
                ...
                ->add_fields( 'text-image', 'Text w/ Image', array(
                    ...
                    Field::make( 'radio', 'two_columns', 'Two Columns?')
                        ->add_options( array(
                            'no' => 'No',
                            'yes' => 'Yes',
                        ))
                    ...
                    Field::make( 'text', 'heading_2col', 'Heading' )
                        ->set_conditional_logic( array(
                        'relation' => 'AND',
                            array(
                                'field' => 'two_columns',
                    ...
                    Field::make( 'rich_text', 'content_2col', 'Content' )
                        ->set_conditional_logic( array(
                        'relation' => 'AND',
                            array(
                                'field' => 'two_columns',
                    ...
                    Field::make( 'image', 'image_2col', 'Image' )
                        ->set_value_type( 'url' )
                        ->set_conditional_logic( array(
                        'relation' => 'AND',
                            array(
                    ...
                    Field::make( 'text', 'button_text_2col', 'Button Text' )
                        ->set_conditional_logic( array(
                        'relation' => 'AND',
                            array(
                                'field' => 'two_columns',
                    ...
                    Field::make( 'text', 'button_url_2col', 'Button URL' )
                        ->set_conditional_logic( array(
                        'relation' => 'AND',
                            array(
                                'field' => 'two_columns',
                ...
                ->add_fields( 'recent-posts', 'Recent Posts', array(
                    Field::make( 'radio', 'post_style', 'Style' )
                        ->add_options( array(
                            'one' => 'Style 1',
                            'two' => 'Style 2',
                        ) ),
