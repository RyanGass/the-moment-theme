...
function theme_name_enqueue_scripts() {
	wp_enqueue_style( 'theme-name', get_template_directory_uri() . '/styles_scripts/dist/_site.css' );
	wp_enqueue_script( 'theme-name', get_template_directory_uri() . '/styles_scripts/dist/scripts.js');
}
