...
<section id="testimonial-single-container" class="w-full pt-24 pb-16 bg-lightgrey">
        ...
        <div class="section-block">
            <div class="area">
                <div class="flex flex-col justify-center text-center inner-area align-center">
                    ...
                    <span class="block quote-name-company"><br><?php echo $section['testimonial_name']; ?> - <?php echo $section['testimonial_company']; ?></span>
                </div>
            </div>
        </div>
    </div>
